...
public class ModifyStudent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		str += "<tr><th>영어</th><td><input type='number' name='escore' value='" + std.getStudentEng() + "'></td></tr>";
		str += "<tr><th>수학</th><td><input type='number' name='mscore' value='" + std.getStudentMath() + "'></td></tr>";
